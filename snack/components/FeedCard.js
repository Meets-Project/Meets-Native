...
export function FeedCard({item}){
 ...
 <Text style={feedCardStyles.cardContent}>{item.content}</Text>{item.image?<View style={feedCardStyles.cardImage}><Text style={feedCardStyles.cardImageEmoji}>{item.image}</Text></View>:null}
