...
export function CreateFlowScreen(){
 ...
 {mode==='event'?<View style={{marginBottom:16}}>
 <View style={authStyles.field}><Text style={authStyles.fieldLabel}>Data (AAAA-MM-DD)</Text><TextInput style={authStyles.fieldInput} value={eventDate} onChangeText={setEventDate} placeholder="2026-09-15" placeholderTextColor="#9a9a9a"/></View>
 <View style={authStyles.field}><Text style={authStyles.fieldLabel}>Horário (HH:MM)</Text><TextInput style={authStyles.fieldInput} value={eventTime} onChangeText={setEventTime} placeholder="19:30" placeholderTextColor="#9a9a9a"/></View>
 <View style={authStyles.field}><Text style={authStyles.fieldLabel}>Local</Text><TextInput style={authStyles.fieldInput} value={location} onChangeText={setLocation} placeholder="Endereço ou local do evento" placeholderTextColor="#9a9a9a"/></View>
 </View>:null}
